...
app.get('/:formId/', asyncHandler(async function (req, res) {
...
app.get('/:formId/inputs', asyncHandler(async function (req, res) {
    const formId = req.params['formId'];
...
app.get('/:formId/records', asyncHandler(async function (req, res) {
    const formId = req.params['formId'];
...
app.post('/:formId/records/', asyncHandler(async function (req, res) {
    const formId = req.params['formId'];
...
app.get('/:formId/records/:recordId', asyncHandler(async function (req, res) {
    const formId = req.params['formId'];
...
app.put('/:formId/records/:recordId', asyncHandler(async function (req, res) {
    const formId = req.params['formId'];
    const recordId = req.params['recordId'];
...
app.delete('/:formId/records/:recordId', asyncHandler(async function (req, res) {
    const formId = req.params['formId'];
    const recordId = req.params['recordId'];
